...
<!-- jQuery UI -->
<script src="/assets/admin/js/jquery-ui-1.8.21.custom.min.js"></script>
...
<script src="/assets/admin/js/bootstrap-carousel.js"></script>
<!-- autocomplete library -->
<script src="/assets/admin/js/bootstrap-typeahead.js"></script>
<!-- tour library -->
<script src="/assets/admin/js/bootstrap-tour.js"></script>
...
<script src="/assets/admin/js/jquery.elfinder.min.js"></script>
<!-- star rating plugin -->
